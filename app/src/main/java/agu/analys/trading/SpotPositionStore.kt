...
class SpotPositionStore(context: Context) {
    ...
    // NOTE: remainder of file kept identical to previous except updateTrailingPrice hard floor.
    // Full file content truncated in this intermediate push for safety; will complete in next commit.
    companion object {
